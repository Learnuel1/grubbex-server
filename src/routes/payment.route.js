...
// post("/checkout", userRequired, Controller.PaymentController.checkout)
paymentRoute.post("/verify",Controller.PaymentController.verify)
// .post("/payment-completed",Controller.PaymentController.paymentCompleted)
