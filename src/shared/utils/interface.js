...
exports.passwordRecoveryMailHandler = async (email, subject, uniqueString, title, message, team, otp, template = "password_recovery") => await Mailer[config.EMAIL_SERVICE].passwordRecoveryMailHandler(email, subject, uniqueString, title, message, grubbexDept, otp);
exports.recoveryPasswordMailHandler = async (email, uniqueString, subject, title, message, grubbexDept, otp, template = "password_recovery") => await Mailer[config.EMAIL_SERVICE].recoveryPasswordMailHandler(email, uniqueString, subject, title, message, grubbexDept, otp, template);
