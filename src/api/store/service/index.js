...
exports.getAllStore = async (query, page, limit) => await StoreModule.allStore(query, page, limit)
...
exports.getProductForSaveItemByProId = async ( prodId) => await ProductModule.productForSaveItemByProId(prodId);
